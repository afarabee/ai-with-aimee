    ...
    <footer className="bg-background neon-border-cyan border-t-2 py-8">
      <div className="max-w-6xl mx-auto px-6">
        <div className="text-center mb-6">
          ...
          <p className="neon-text-cyan/70 mt-2 mb-4">Product Manager • AI Builder • Lifelong Learner</p>
        </div>
        ...
        <p className="neon-text-cyan/50 text-sm text-center">© 2026 Aimee Farabee. Built with passion and curiosity.</p>
      </div>
    </footer>);
