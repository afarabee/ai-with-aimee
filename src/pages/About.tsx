        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-16 items-start mb-16">
            ...
            lineHeight: '1.6'
              ...
              <p>
                With more than 15 years in product management at large enterprises like Express Scripts, Cigna, and American Express, I have built my career at the intersection of technology, business, and human needs. My work is guided by a belief that great products do more than deliver features, they solve meaningful problems in smart, scalable ways.
              </p>
